                                            ...
                                            <table class="table table-striped table-bordered zero-configuration">
                                                ...
                                                <c:forEach items="${listAllCategory}" var="category">
                                                    <tr>
                                                        ...
                                                        <td>${category.name}</td>
                                                        <c:set var="shortDesc" value="${fn:substring(category.descriptions, 0, 50)}" />
                                                        <td><p>${shortDesc}</p></td>
                                                        <td>${category.parentId}</td>
                                                        <td>${category.displayNumber}</td>
                                                        <td>
                                                            <c:choose>
                                                        ...
                                                        <td>    
                                                            <table>
                                                                <tbody>
                                                                <td><span class="delete_category" data-categoryid="${category.categoryId}" onclick="return confirm('Do you want to delete?')" style="cursor:pointer"><i class="fa fa-trash " style="color:red"></i></span></td>
                                                                <td><span><a href="categorydetail.htm?Id=${category.categoryId}"><i class="fa fa-eye" style="color:green"></i></a></span></td>
                                                                </tbody>
                                                            </table>
                                                        </td>
                                                    </tr>
